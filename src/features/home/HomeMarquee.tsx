...
import { Marquee, RevealRoot } from "@/components/motion";
import { Atmosphere } from "@/components/sections";
 ...
 * to /industries. The band blur-dissolves into view (its distinct entrance)
 * over a quiet ambient layer.
 */
export function HomeMarquee() {
  return (
    <section aria-label="Industries we serve" className="section-exhale texture relative overflow-hidden py-14 lg:py-20">
      <RevealRoot>
        <Atmosphere tone="dark" particles={false} />
        <Link
          href="/industries"
          data-cursor-label="Industries"
          data-reveal-blur
          className="relative block"
          aria-label="Explore the industries we serve"
        >
          <Marquee speed={44}>
