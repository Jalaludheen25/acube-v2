...
import { AboutHero, AboutMission, AboutTeam, AboutTimeline, AboutValues, AboutVision } from "@/features/about";
    ...
    <main id="main" className="relative bg-background">
      ...
      <RevealRoot>
        <div className="relative">
          ...
          <div className={cn(container.content, "relative pt-16 lg:pt-20")}>
            <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "About" }]} />
          </div>

          {/* Mission */}
          <section aria-label="Our mission" className="relative bg-background">
            <div className={cn(container.content, "py-16 lg:py-20")}>
              <AboutMission />
            </div>
          </section>

          {/* Vision */}
          <section aria-label="Our vision" className="relative bg-background">
            <div className={cn(container.content, "pb-16 lg:pb-20")}>
              <AboutVision />
            </div>
          </section>

          {/* Values */}
          <section aria-label="Our values" className="relative bg-background">
          ...
          <section aria-label="By the numbers" className="section-exhale texture relative overflow-hidden">
            <div className={cn(container.content, "py-20 lg:py-28")}>
              <p
                data-reveal
                className={cn(typography.label, "flex items-center justify-center gap-3 text-center text-gold")}
              >
          ...
          <section aria-label="How we work" className="relative bg-background">
            <div className={cn(container.content, "pb-24 lg:pb-32")}>
              <SectionIntro eyebrow="How we work" title="From first question to fully operational." size="h2" split />
          ...
          {/* Team (placeholder — no verified roster yet) */}
          <section aria-label="Our team" className="relative bg-background">
            <div className={cn(container.content, "pb-24 lg:pb-32")}>
              <SectionIntro eyebrow="The people behind ACUBE" title="Our team." size="h2" />
              <div className="mt-16">
                <AboutTeam />
              </div>
            </div>
          ...
          <section aria-label="Our principles" className="relative bg-background">
            <div className={cn(container.content, "pb-24 lg:pb-32")}>
              ...
              <ul className="mt-16 grid gap-x-16 gap-y-10 border-t border-divider pt-12 md:grid-cols-2" data-reveal-stagger>
          ...
          <section aria-label="Visit us" className="relative bg-background">
            <div className={cn(container.content, "pb-24 lg:pb-32")}>
              <div data-reveal-scale className="glass-depth relative overflow-hidden rounded-[var(--radius-2xl)] p-8 lg:p-12">
                <span
                  aria-hidden
                  data-parallax="0.15"
                ...
                <div className="relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      ...
                      <p className={cn(typography.body, "mt-3 max-w-md text-muted")}>{contact.address.formatted}</p>
                    </div>
                  </div>
